                ...
                <Grid.Row columns={2}>
                  <Grid.Column>
                    <List>
                      <List.Item>
                        <Image
                          avatar
                          src={`${config.api}${post.author.picture}`}
                        />
                        <List.Content>
                          <List.Header as="a">
                  ...
                  <Grid.Column textAlign="right">
                    <div>
                      <a
                        target="_blank"
                        href={`https://www.facebook.com/sharer/sharer.php?u=${config.host}/post/${post.url}`}
                      >
                        <Icon bordered color="blue" name="facebook" />
                      </a>
                      <a
                        target="_blank"
                        href={`https://twitter.com/intent/tweet?url=${config.host}/post/${post.url}`}
                      >
